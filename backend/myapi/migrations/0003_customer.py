...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('myapi', '0002_alter_event_manager'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', tinymce.models.HTMLField(blank=True, default='Customer Bio', null=True)),
                ('events', models.ManyToManyField(blank=True, related_name='customers', to='myapi.event')),
